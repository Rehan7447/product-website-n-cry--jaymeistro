                        ...
                        <div className="col-12 col-md-7">
                            ...
                            <form className="item-form card no-hover">
                                <div className="row">
                                    ...
                                    <div className="col-12 col-md-6">
                                        <div className="form-group">
                                        <select id="currency" name="Currency"  className="form-control select" required="required" placeholder="Currency">
                                            <option value="" selected disabled hidden> Select Blockchain</option>
                                    ...
                                    <div className="col-12">
                                        <div className="form-group mt-3">
                                            <div className="form-check form-check-inline">
                                                ...
                                                <label className="form-check-label" htmlFor="inlineRadio1">Put at Auction</label>
                                            </div>
                                            <div className="form-check form-check-inline">
